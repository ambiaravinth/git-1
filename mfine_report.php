...
if (isset($json_data->PatientRiskDetails)) {
    ...
    $SMOKING = $json_data->PatientRiskDetails[0]->SMOKING ?? null;
    $DIABETETS = $json_data->PatientRiskDetails[0]->DIABETETS ?? null;
    $DIABETIC_TYPE = $json_data->PatientRiskDetails[0]->DIABETIC_TYPE ?? null;
    $DiabetesType2 = $json_data->PatientRiskDetails[0]->DiabetesType2 ?? null;
    $InsulinTreatmentForType2Diabetic = $json_data->PatientRiskDetails[0]->InsulinTreatmentForType2Diabetic ?? null;
    $PREVIOUS_NTD = $json_data->PatientRiskDetails[0]->PREVIOUS_NTD ?? null;
    $CHRONIC_HYPERTENSION = $json_data->PatientRiskDetails[0]->CHRONIC_HYPERTENSION ?? null;
    $FAMILY_HISTORY_OF_PE = $json_data->PatientRiskDetails[0]->FAMILY_HISTORY_OF_PE ?? null;
    $PREVIOUS_DOWN = $json_data->PatientRiskDetails[0]->PREVIOUS_DOWN ?? null;
    $PATAUS_SYNDROME = $json_data->PatientRiskDetails[0]->PATAUS_SYNDROME ?? null;
    $PREVIOUS_EDWARDS = $json_data->PatientRiskDetails[0]->PREVIOUS_EDWARDS ?? null;
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <span class="number">
                                                    ...
                                                    if (trim($testResults['printing_name']) === 'PAPPA') {

                                                        $software = $riskSoftwareMethodByPrint ?? '';

                                                        if ($software === 'LIFECYCLE') {
                                                            echo 'mU/L';
                                                        } elseif ($software === 'PRISCA') {
                                                            echo 'mIU/mL';
                                                        } else {
                                                            echo $testResults['uom_value'];
                                                        }
                                                    } else {
                                                        echo $testResults['uom_value'];
                                                    }
