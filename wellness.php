...
<body onload="number_pages()">
    ...
    if (($bloodResults['rbccount_color_code'] == 'red') || ($bloodResults['hematocrit_pcv_color_code'] == 'red') ||
        ...
        ($bloodResults['lactate_dehydragenase_LDH_serum__color_code'] == 'red') || ($bloodResults['mch_color_code'] == 'red') || ($bloodResults['erythrocyte_sedimentation_color_code'] == 'red')
    ) {
        ...
        ($bloodResults['lactate_dehydragenase_LDH_serum__color_code'] == 'orange') || ($bloodResults['mch_color_code'] == 'orange')  || ($bloodResults['erythrocyte_sedimentation_color_code'] == 'orange')
    ) {
...
<div class='footer-cls' style='margin-top: 10px;'>
    ...
    $currentPage = 1;
    $totalPages = ($urineResults['urinestatus_found'] == 1) ? 24 : 26;
    ?>
            ...
            <div class="resultDetails" style="page-break-after: always;">
                ...
                <div style="padding-top: 20px;">
                    <div style="text-align: center;font-weight: bold;font-size: 22px;">
                        ...
                        <?php } ?>
                        <?php if ($patientDetails['PackageCode'] == 'AYN_017' || $patientDetails['PackageCode'] == 'AYN_027') { ?>
                        ...
                        <tr>
                            <td class="leftPanel">
                                <div class="graphDetail">
                                    ...
                                    <div>
                                        <span class="<?= $pancreasResults['glucose_fasting_color_code']; ?>" style="  font-size: 45px;">
                                            <?php echo (($pancreasResults['glucose_fasting_result_value'] != '') ? $pancreasResults['glucose_fasting_result_value'] : '') ?></span> <?php echo htmlspecialchars($pancreasResults['glucose_fasting_uom']); ?></span>
                                    </div>
                    ...
                    <tr>
                        <td class="leftPanel">
                            <div class="graphDetail">
                                <p style="color: #333;font-weight:600;">Your Result Value</p>
                                <div>
                                    <span class="<?= $pancreasResults['hba1c_color_code']; ?>" style="  font-size: 45px;">
                                ...
                                <table class="image-result">
                                    <tr>
                                        ...
                                        <td class="<?= $pancreasResults['hba1c_color_code']; ?> image-ressult">
                                            <?= ($pancreasResults['hba1c_result_value_in_words'] != '') ? $pancreasResults['hba1c_result_value_in_words'] : '' ?>
                                        </td>
                                    </tr>
                                </table>
                                <table class="mediacal-update">
    ...
    <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
        <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
            ...
            <table cellspacing="0" cellpadding="0" class="graphBArContentSection float-left w-50" style="padding-left: 10px; padding-bottom:13%;">
                <tr>
                    <td class="leftPanel blood">
                        <div class="graphDetail">
                            <p style="color: #333;font-weight:600;">Your Result Value</p>
                ...
                <tr>
                    <td class="leftPanel blood">
                        <div class="graphDetail">
                            ...
                            <div style="font-size: 34px; white-space: nowrap;">
                                ...
                                <span style="font-size: 16px;">
                                    <?php echo htmlspecialchars($bloodResults['basophil_count_uom']); ?>
                                </span>
                            </div>
                            <table class="image-result">
                                <tr>
        ...
        <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
            ...
            <table cellspacing="0" cellpadding="0" class="graphBArContentSection float-left w-50">
                <tr>
                    ...
                    <!-- LDH (Lactatedehydragenase), Serum -->
                    <td class="rightPanel">
                        <div class="graphContent" style="position: relative;">
                            <div style="display: flex; align-items: center; justify-content: space-between; position: relative;">
            ...
            <?php if (!empty($bloodTestgroupdetails['CBC_blood_remarks']) || !empty($bloodTestgroupdetails['E0005_blood_remarks']) || !empty($bloodTestgroupdetails['L0002_blood_remarks'])) { ?>
                <div style="padding-top: 2.5px;">
                    <p class="sample-type-para">
                        <span class="p-tag" style="font-size: 16px;">Remarks :</span>
                        <?= htmlspecialchars($bloodTestgroupdetails['CBC_blood_remarks']) ?>
