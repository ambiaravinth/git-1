 ...
 */
class CbMagentoLogController extends BaseController
{
    use ResponseTrait;
    ...
    {
        $this->users = new CbMagentoLogsModel();
        helper('common');
    }
    ...
    public function index()
    {
        if ($this->request->isAJAX()) {
            ...
            $order = CbMagentoLogsModel::ORDERABLE[$this->request->getGet('order[0][column]')];
         ...
         return view('Views/User/cbmagentologs', ['title'    => lang('CB & Magento Logs'), 'subtitle' => lang('')]);
    }
