 ...
 */
class CbStemcellLogController extends BaseController
{
    use ResponseTrait;
    ...
    {
        $this->users = new CbStemcellLogsModel();
        helper('common');
    }
    ...
    public function index()
    {
        if ($this->request->isAJAX()) {
            ...
            $order = CbStemcellLogsModel::ORDERABLE[$this->request->getGet('order[0][column]')];
        ...
        return view('Views/User/cbstemcelllogs', ['title'    => lang('CB & Stem Cell Logs'), 'subtitle' => lang('')]);
    }
