...
<body onload="number_pages()">
    ...
    if($heartResults['lipoprotein_ldl_status_found']){
        ...
        ($heartResults['nonhdlcholesterol_color_code'] == 'red')
        ) {
        ...
        ($heartResults['nonhdlcholesterol_color_code'] == 'orange')
        ) {
    ...
    if (($kidneyResults['urea_result_color_code'] == 'red') || ($kidneyResults['creatinine_color_code'] == 'red') ||
        ...
        ($kidneyResults['creatinine_ratio_color_code'] == 'red') || ($kidneyResults['sodium_result_color_code'] == 'red') || ($kidneyResults['potassium_result_color_code'] == 'red') || ($kidneyResults['chloride_result_color_code'] == 'red')  || ($kidneyResults['egfr_color_code'] == 'red')
        ...
        ($kidneyResults['creatinine_ratio_color_code'] == 'orange') || ($kidneyResults['sodium_result_color_code'] == 'orange') || ($kidneyResults['potassium_result_color_code'] == 'orange') || ($kidneyResults['chloride_result_color_code'] == 'orange') || ($kidneyResults['egfr_color_code'] == 'orange')
    ) {
        ...
        ($kidneyResults['creatinine_ratio_color_code'] == 'green') || ($kidneyResults['sodium_result_color_code'] == 'green') || ($kidneyResults['potassium_result_color_code'] == 'green') || ($kidneyResults['chloride_result_color_code'] == 'green') ||  ($kidneyResults['egfr_color_code'] == 'green')
    ) {
    ...
    if (($liverResults['ggt_result_found_view'] == 1)) {
        if (($liverResults['bilirubin_color_code'] == 'red') || ($liverResults['bilirubin_direct_color_code'] == 'red') ||
            ...
            ($liverResults['ag_ratio_color_code'] == 'red')
        ) {
            ...
            ($liverResults['ag_ratio_color_code'] == 'orange')
        ) {
    ...
    if (($bloodResults['rbccount_color_code'] == 'red') || ($bloodResults['hematocrit_pcv_color_code'] == 'red') ||
        ...
        ($bloodResults['monocyte_count_color_code'] == 'red') || ($bloodResults['lymphocyte_count_color_code'] == 'red') ||
        ...
        ($bloodResults['basophils_color_code'] == 'red') || ($bloodResults['mch_color_code'] == 'red')
    ) {
        ...
        ($bloodResults['monocyte_count_color_code'] == 'orange') || ($bloodResults['lymphocyte_count_color_code'] == 'orange') ||
        ...
        ($bloodResults['basophils_color_code'] == 'orange') ||  ($bloodResults['mch_color_code'] == 'orange')
    ) {
        ...
        ($bloodResults['monocyte_count_color_code'] == 'green') || ($bloodResults['lymphocyte_count_color_code'] == 'green') ||
        ...
        ($bloodResults['basophils_color_code'] == 'green') ||  ($bloodResults['mch_color_code'] == 'green')
    ) {
    ...
    if (($miniralVitaminIronResults['vitaminbtwelve_color_code'] == 'red') || ($miniralVitaminIronResults['vitamind_color_code'] == 'red') ||
       ...
       // ($miniralVitaminIronResults['folic_acid_color_code'] == 'orange') || ($bloodRminiralVitaminIronResultsesults['phosphorus_color_code'] == 'orange') ||
        (! empty($miniralVitaminIronResults['ferritin_color_code']) == 'orange') || ($miniralVitaminIronResults['iron_color_code'] == 'orange') ||
       ...
       // ($miniralVitaminIronResults['folic_acid_color_code'] == 'green') || ($miniralVitaminIronResults['phosphorus_color_code'] == 'green') ||
        (! empty($miniralVitaminIronResults['ferritin_color_code']) == 'green') || ($miniralVitaminIronResults['iron_color_code'] == 'green') || ($miniralVitaminIronResults['iron_saturation_color_code'] =='green')
        ($miniralVitaminIronResults['uibc_color_code'] == 'green') || ($miniralVitaminIronResults['tibc_color_code'] == 'green')
    ) {
 ...
 $footerNablLogo = '';
    ...
    <?php
    $currentPage = 1;
    $totalPages = ($urineResults['urinestatus_found'] == 1) ? 23 : 25;
    ?>
    ...
    <div class="body-cl">
            ...
            <div class="resultDetails" style="page-break-after: always;">
                ...
                <div style="padding-top: 20px;">
                    <div style="text-align: center;font-weight: bold;font-size: 22px;">
                        <?php if ($patientDetails['PackageCode'] == 'AYN_016' || $patientDetails['PackageCode'] == 'AYN_026') { ?>
                            <td style="color: #333;font-size: 16px; font-weight:600; ">Vital Package</td>
                        <?php } ?>
                        <?php if ($patientDetails['PackageCode'] == 'AYN_017') { ?>
                            <td style="color: #333;font-size: 16px; font-weight:600;">Wellness Package</td>
                        <?php } ?>
                        <?php if ($patientDetails['PackageCode'] == 'AYN_018') { ?>
                            <td style="color: #333;font-size: 16px; font-weight:600;">Wellness Plus Package</td>
                        <?php } ?>
                    </div>
                    ...
                    <div style="width: 50%;" class="float-left">
                        <table style="text-align:left; margin-right:0; width:65%; font-weight:700;" class="margin-auto">
                            ...
                            <tr>
                                ...
                                <td>: </td>
                                <td class="f-14" style="text-align: end;width: 10%; white-space: nowrap;"><?= $patientDetails['receipt_date']; ?></td>
                            </tr>
                            <tr>
                                <td class="f-14 w-50">Reported On</td>
                                <td>: </td>
                                <td class="f-14" style="text-align: end;width: 10%; white-space: nowrap;"><?= $patientDetails['reporting_date']; ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <table style="width: 65%; margin-top:100px; margin-left:25px;" class="float-left border-collapse">
                    ...
                    <tr>
                        ...
                        <td class="imp-para"><?= (!$urineResults['urinestatus_found']) ? '22' : '20' ?></td>
                    </tr>
                    <tr>
                        <td class="imp-para"><img src="https://cdn.shop.lifecell.in/reports/wellness/images/h-report-icon.png" alt="" /></td>
                        <td class="imp-para">Suggestions for Preventive Tests</td>
                        <td class="imp-para"><?= (!$urineResults['urinestatus_found']) ? '24' : '22' ?></td>
                    </tr>
                </table>
            ...
            <div class="resultDetails" style="page-break-after: always; padding-top: 50px;">
                ...
                <table style="width: 45%; padding-top: 50px;" class="float-left">
                    ...
                    <tr>
                        ...
                        <?php if (($patientDetails['PackageCode'] == 'AYN_017') || ($patientDetails['PackageCode'] == 'AYN_026')) { ?>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                        ...
                        <tr>
                                ...
                                <div class="graphDetail">
                                    ...
                                    <div>
                                        <span class="<?= $pancreasResults['glucose_fasting_color_code']; ?>" style="font-size: 34px;">
                                            <?= ($pancreasResults['glucose_fasting_result_value'] != '') ? $pancreasResults['glucose_fasting_result_value'] : '' ?>
                                        </span> <?php echo htmlspecialchars($pancreasResults['glucose_fasting_uom']); ?></span>
                                    </div>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <div style="position: absolute; top: -5px; right: 0; display: grid; max-width: 40%;">
                                        <?php if ($pancreasResults['glucose_fasting_is_nabl_accredited'] == 1 && !($patientDetails['hospital_logo']['combained'])): ?>
                                            <div style="width:100%; height: fit-content; text-align: center;">
                                                <img src="https://reports.lifecell.in/images/footer-logo-pns-new.png" alt="" style="width: auto; height: 40px;">
                                            </div>
                                            <div style="color: #000; font-size: 8px; line-height: 8px; white-space: nowrap; text-align: center;">
                ...
                <?php
                if (!empty($pancreasResults['hbA1c_test_remraks']) || !empty($pancreasResults['glucose_fasting_test_remraks'])) {
                ?>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                        ...
                        <tr>
                            <td class="leftPanel">
                                <div class="graphDetail">
                                    ...
                                    <table class="mediacal-update">
                                        <td>Range</td>
                                        <?php if (!empty($heartResults['lipoprotein_ldl_result_value'])) { ?>
                                            <td> : <?php echo $heartResults['lipoprotein_ldl_BRInterval_result_value'] . " " . $heartResults['lipoprotein_ldl_uom']; ?> </td>
                                        <?php } else { ?>
                                            <td> : <?php echo $heartResults['lipoprotein_ldl_result_value'] . " - " . $heartResults['lipoprotein_ldl_high_result_value'] . " " . $heartResults['lipoprotein_ldl_uom']; ?> </td>
                                        <?php } ?>
                                    </table>
                                </div>
                            </td>
                ...
                <?php if (!empty($heartTestgroupdetails['lipid_profile_heart_remarks'])) { ?>
                    <div style="padding-top: 2.5px;">
                        <p class="sample-type-para">
                            <span class="p-tag" style="font-size: 16px;">Service Remarks :</span>
                                    ...
                                    <table class="image-result">
                                        <tr>
                                            <?php if ($thyroidResults['thyroxine_result_value_cleaned'] <  $thyroidResults['t_four_low_result_value']) { ?>
                                                <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/green-thumb.png" /></td>
                                            <?php } ?>
                    ...
                    <tr>
                        <td class="leftPanel">
                            <div class="graphDetail">
                                <p style="color: #333;font-weight:600;">Your Result Value</p>
                                <div>
                                    <span class="<?= $kidneyResults['ra_factror_color_code']; ?>" style="font-size: 34px;">
                                        <?php echo (($kidneyResults['ra_factror_value'] != '') ? $kidneyResults['ra_factror_value'] : '') ?>
                                    </span> <?php echo htmlspecialchars($kidneyResults['ra_factror_uom']); ?>
                                </div>
                                <table class="image-result">
                                    <tr>
                                        <?php if ($kidneyResults['ra_factror_value_cleaned'] < $kidneyResults['ra_factror_high_result_value']) { ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/green-thumbs.png" /></td>
                                        <?php } else { ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                        <?php } ?>
                                        <td class="<?= $kidneyResults['ra_factror_color_code']; ?> image-ressult">
                                            <?php echo (($kidneyResults['ra_factror_value_in_words'] != '') ? $kidneyResults['ra_factror_value_in_words'] : '') ?>
                                        </td>
                                    </tr>
                                </table>
                                <table class="mediacal-update">
                                    <td>Range</td>
                                    <?php if (!empty($kidneyResults['ra_factror_BRInterval_result_value'])) { ?>
                                        <td> : <?php echo $kidneyResults['ra_factror_BRInterval_result_value'] . " " . $kidneyResults['ra_factror_uom']; ?> </td>
                                    <?php } else { ?>
                                        <td> : <?php echo $kidneyResults['ra_factror_low_result_value'] . " - " . $kidneyResults['ra_factror_high_result_value'] . " " . $kidneyResults['ra_factror_uom']; ?> </td>
                                    <?php } ?>
                                </table>
                            </div>
                        </td>
                        ...
                        <!-- <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                <div style="display: flex; align-items: center; justify-content: space-between; position: relative;">
                                    <h4 style="margin: 0;">RA Factor</h4>
                                    <p class="methodology" style="margin: 0;"> <?php //echo $kidneyResults['ra_factror_sample_method']; ?> </p>
                                </div> -->
                                <!-- NABL Logo and Code Positioned Absolutely -->
                                <!-- <div style="position: absolute; top: -5px; right: 0; display: grid; max-width: 40%;">
                                    <?php //if ($kidneyResults['ra_factror_is_nabl_accredited'] == 1  && !($patientDetails['hospital_logo']['combained'])): ?>
                                        <div style="width:100%; height: fit-content; text-align: center;">
                                            <img src="https://reports.lifecell.in/images/footer-logo-pns-new.png" alt="" style="width: auto; height: 40px;">
                                        </div>
                                        <div style="color: #000; font-size: 8px; line-height: 8px; white-space: nowrap; text-align: center;">
                                            <?php //echo $kidneyTestgroupdetails['R0004_kidney_nabl_code']; ?>
                                        </div>
                                    <?php //endif; ?>
                                </div>
                                <p style="margin-top:5px;"> The rheumatoid factor is also found in the blood of healthy people. And it’s found in people with other immune system conditions like lupus and Sjogren's syndrome. People with chronic infections like viral hepatitis can have elevated RA factor. About 20 percent of people with rheumatoid arthritis have little or no rheumatoid factor in their blood. So even if the results are normal, we need more tests to confirm or rule out a diagnosis.</p>
                                <?php //if ($kidneyResults['ra_factror_impact_on_health'] != '') { ?>
                                    <h4 style="font-size: 18px;">Impact on health</h4>
                                    <p>
                                        <?php //echo ($kidneyResults['ra_factror_impact_on_health'] != '') ? $kidneyResults['ra_factror_impact_on_health'] : '' ?>
                                    </p>
                                <?php //} ?>
                            </div>
                        </td>
		...
		page-break-before: always;">
                <div>
                    <?php
                    // echo $footerWithLogo; 
                    echo NewFooter(['RFT-Basic', 'R0004'], $tgdrsig_details, $footerLogo, $patientDetails,$footerNablLogo);
                    ?>
                </div>
                <div class="pageno">Page <?= $currentPage++ ?> of <?= $totalPages ?></div>
            </footer>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <?php } ?>
                <?php if ($patientDetails['PackageCode'] !== 'AYN_017' && $patientDetails['PackageCode'] !== 'AYN_018' && $patientDetails['PackageCode'] !== 'AYN_026') { ?>
                    <table cellspacing="0" cellpadding="0" class="graphBArContentSection">
                        <tr>
                            <td class="leftPanel">
                                <div class="graphDetail">
                                    <p style="color: #333;font-weight:600;">Your Result Value</p>
                                    <div>
                                        <span class="<?= $miniralVitaminIronResults['ra_factror_color_code']; ?>" style="font-size: 34px;">
                                            <?php echo (($miniralVitaminIronResults['ra_factror_result_value'] != '') ? $miniralVitaminIronResults['ra_factror_result_value'] : '') ?>
                                        </span><?php echo htmlspecialchars($kidneyResults['ra_factror_uom']); ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent">
                                    <h4>RA factor</h4>
                                    <p class="methodology"><?= $miniralVitaminIronResults['ra_factror_sample_method']; ?></p>
                                    <p>An RF test is often used to help diagnose rheumatoid arthritis and other autoimmune disorders. RF testing may also be used to understand how severe rheumatoid arthritis may be and whether it's likely to affect organs.
                                    </p>
                                    <?php if ($miniralVitaminIronResults['tibc_impact_on_health'] != '') { ?>
                                        <h4 style="font-size: 18px;">Impact on health</h4>
                                        <p>
                                            <?php echo ($miniralVitaminIronResults['tibc_impact_on_health'] != '') ? $miniralVitaminIronResults['tibc_impact_on_health'] : '' ?>
                                        </p>
                                    <?php } ?>
                                </div>
                            </td>
                ...
                <div style="float:left;">
                    ...
                    <div>
                        <p class="suggestions-para" style="padding-bottom:0%;">
                                ...
                                <table class="image-result">
                                    <tr>
                                        <?php if ((float)$liverResults['bilirubin_direct_result_value'] < $liverResults['bilirubin_direct_high_result_value']) { ?>
                                            <td>
                                                <img src="https://cdn.shop.lifecell.in/reports/wellness/images/green-thumbs.png" />
                                            </td>
                                        <?php } ?>
                                        <?php if ((float)$liverResults['bilirubin_direct_result_value'] >= $liverResults['bilirubin_direct_high_result_value']) { ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <?php if (!empty($liverTestgroupdetails['LFT_liver_remarks'])) { ?>
                    <div style="padding-top: 2.5px;">
                        <p class="sample-type-para">
                            <span class="p-tag" style="font-size: 16px;">Service Remarks :</span>
                ...
                <div style="padding-top: 2px;">
                    <p class="p-tag">About your Liver Results</p>
                    <?php
                    // Liver Results
                    ...
                    if ($liverResults['sgpt_alt_color_code'] != 'green') {
                        $liverResults['sgpt_alt'] = 'SGPT-ALT,';
                    } else {
                    ...
                    <?php if ($liverResults['ggt_result_found_view'] == 1) { ?>
                        <?php if (
                            ...
                            <p style="font-size: 14px;">During your health check, we have found out that &nbsp;
                                ...
                                is your concern parameters, which can impact your health.
                            </p>
                        <?php } else { ?>
                            <p style="font-size: 14px;">All the results are Normal.</p>
                        <?php } ?>
                    <?php } else { ?>
                        <?php if (
                            $liverResults['bilirubin_color_code'] != 'green' ||
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                    ...
                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <!-- NABL Logo and Code Positioned Absolutely -->
                                <div style="position: absolute; top: -5px; right: 0px; display: grid; max-width: 40%;">
                                    <?php if ($bloodResults['rbccount_is_nabl_accredited'] == 1  && !($patientDetails['hospital_logo']['combained'])): ?>
                                        ...
                                        <div style="color: #000; font-size: 8px; line-height: 8px; white-space: nowrap; text-align: center;">
                                            <!-- <?= $bloodTestgroupdetails['CBC_blood_nabl_code']; ?> -->
                                            <?php
                                            $code = $bloodTestgroupdetails['CBC_blood_nabl_code'] ?? '';
                                            echo (strlen($code) >= 10) ? wordwrap($code, ceil(strlen($code) / 2), '<br>', true) : $code; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <!-- NABL Logo and Code Positioned Absolutely -->
                                <div style="position: absolute; top: -5px; right: -10PX; display: grid; min-width: 30%;">
                ...
                <table cellspacing="0" cellpadding="0" class="graphBArContentSection float-left w-50" style="padding-left: 10px; padding-bottom:15%;">
                    <tr>
                        <td class="leftPanel blood">
                            <div class="graphDetail">
                                <p style="color: #333;font-weight:600;">Your Result Value</p>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <!-- NABL Logo and Code Positioned Absolutely -->
                                <div style="position: absolute; top: -5px; right: -13px; display: grid; min-width: 30%;">
                            ...
                            <div class="graphDetail">
                                ...
                                <table class="mediacal-update">
                                    ...
                                    <?php if (!empty($bloodResults['leukocytes_count_BRInterval_result_value'])) { ?>
                                        <td style="width: 75%;  white-space: nowrap;"> : <?php echo $bloodResults['leukocytes_count_BRInterval_result_value'] . " " . $bloodResults['leukocytes_count_uom']; ?> </td>
                                    <?php } else { ?>
                                        <td style="width: 75%;  white-space: nowrap;"> : <?php echo $bloodResults['leukocytes_count_low_result_value'] . " - " . $bloodResults['leukocytes_count_high_result_value'] . " " . $bloodResults['leukocytes_count_uom']; ?> </td>
                                    <?php } ?>
                                </table>
                            </div>
                        </td>
                        ...
                        <td class="leftPanel blood">
                            <div class="graphDetail">
                                ...
                                <div style="white-space: nowrap;">
                                    ...
                                    <span style="font-size: 16px;">
                                        <?php echo htmlspecialchars($bloodResults['neutrophils_count_uom']); ?>
                                    </span>
                                </div>
                                <table class="image-result">
                                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <div style="position: absolute; top: -5px; right: -17px; display: grid; min-width: 30%;">
                        ...
                        <td class="leftPanel blood">
                            <div class="graphDetail">
                                ...
                                <div style="white-space: nowrap;">
                                    ...
                                    <span style="font-size: 16px;">
                                        <?php echo htmlspecialchars($bloodResults['monocyte_count_uom']); ?>
                                    </span>
                                </div>
                                <table class="image-result">
                                    <tr>
                        ...
                        <td class="leftPanel blood">
                            <div class="graphDetail">
                                ...
                                <div style="white-space: nowrap;">
                                    ...
                                    <span style="font-size: 16px;">
                                        <?php echo htmlspecialchars($bloodResults['eosinophil_count_uom']); ?>
                                    </span>
                                </div>
                                <table class="image-result">
                                    <tr>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <table cellspacing="0" cellpadding="0" class="graphBArContentSection float-left w-50" style="padding-left: 10px;">
                    <tr>
                        <td class="leftPanel blood">
                            <div class="graphDetail" style="min-height:153px;">
                                <p style="color: #333;font-weight:600;">Your Result Value</p>
                                <div>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <p style="margin-top:19px">Platelets are the cell that helps in blood clotting. This test is used to check the levels of platelets in your blood.</p>
                ...
                <div style="float: left;"> <!-- Added float:left here -->
                    <div style="padding-top: 5px;">
                        <p class="sample-type-para">
                            <span class="p-tag" style="font-size: 16px;">Sample Type :</span> EDTA Whole Blood
                        </p>
                    </div>
                    <?php if (!empty($bloodTestgroupdetails['CBC_blood_remarks'])) { ?>
                        <div style="padding-top: 2.5px;">
                            <p class="sample-type-para">
                                <span class="p-tag" style="font-size: 16px;">Service Remarks :</span>
                    ...
                    <div>
                        <p class="suggestions-para">
                            <span class="p-tag" style="font-size: 16px;">Suggestions :</span>
                            (1) If your hemoglobin level is lower than normal, you have anemia. There are many forms of anemia and with different causes which
                            ...
                            higher than normal it may be because of causes like Polycythemia Vera, heavy smoking, etc.
                            (2) Low levels of iron or vitamins in the body can cause anemia. Poor diet or certain diseases might lead to anemia.
                            Good sources of iron - Spinach & dark green leafy vegetables, Beetroot, Watermelon, Pomegranate, etc.
                            Good sources of Vitamin B12 - Meat, salmon, milk, cheese, eggs, etc. Kindly consult your clinician for further follow-up & management.
                        </p>
                    </div>
                    <?php
                    if (
    ...
    <div class="body-cl"> -->
                        ...
                        <tr>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <p style="margin-top: 19px;">This test checks for presence or absence of protein in urine</p>
                                </div>
                        ...
                        <tr>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <p style="margin-top:19px;">This test checks for presence or absence of Glucose in urine</p>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <p style="margin-top:19px;">This test checks for presence or absence of Ketones in urine</p>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <p style="margin-top:19px;">This test checks for presence or absence of Bilirubin in urine</p>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <p style="margin-top:19px;">This test checks for presence or absence of Nitrite in urine</p>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <p style="margin-top:19px;">This test checks for presence or absence of Blood in urine</p>
                                </div>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <table style="display:table-cell; height:280px; background: #f2faff;" class="w-50">
                    <tr>
                        <td class="donts">Dont's</td>
                    </tr>
                    <tr class="d-block guidance">
                ...
                <table class="border-collapse" style="width:100%; margin: 10px; border: 1px solid #777;">
                    ...
                    <tr>
                        ...
                        <?php if (
                            ...
                            <?php } ?>
                        <?php } else { 
                            // Assign values when LDL status is NOT found (exclude VLDL)
                            $heartResults['total_cholesterol'] = ($heartResults['total_cholesterol_color_code'] != 'green') ? 'Total Cholesterol,' : '';
                            $heartResults['triglycerides'] = ($heartResults['triglycerides_color_code'] != 'green') ? 'Triglycerides,' : '';
                            $heartResults['HDL_cholesterol'] = ($heartResults['hdl_cholesterol_color_code'] != 'green') ? 'HDL Cholesterol,' : '';
                            $heartResults['low_Density_lipoprotein'] = ($heartResults['lipoproteincholesterol_color_code'] != 'green') ? 'Low Density Lipoprotein - Cholesterol (LDL),' : '';
                    ...
                    <tr>
                        ...
                        <?php if (
                            ...
                            $bloodResults['lymphocyte_color_code'] == 'green' && $bloodResults['monocytes_color_code'] == 'green' && $bloodResults['mch_color_code'] == 'green'
                        ) { ?>
                    ...
                    <tr>
                        ...
                        <?php if (
                            ...
                            $miniralVitaminIronResults['tibc_color_code'] == 'green' &&  $miniralVitaminIronResults['iron_saturation'] == 'green'
                        ) { ?>
                            <td class="tests">
                                <?php if (($patientDetails['PackageCode'] == 'AYN_016')) { ?>
                                    Vitamins & Iron - Nil
                    ...
                    <tr>
                        ...
                        <?php if (!$urineResults['urinestatus_found']) { ?>
                            <?php if (
                                ...
                                $urineResults['urine_puscell_color_code'] == 'green' && $urineResults['urine_epithelialcell_color_code'] == 'green' && $urineResults['bacteria_color_code'] == 'green' &&
