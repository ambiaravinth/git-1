...
<body onload="number_pages()">
    ...
    $cancermakerResults = $reportData['cancermakerResults'];
    ...
    $cancerMakerTestgroupdetails = $reportData['cancerMakerTestgroupdetails'];
    // print '<pre>';
    //print_r($min_vit_iron_Testgroupdetails);
    // exit;
   ...
   if($heartResults['lipoprotein_ldl_status_found']){
    ...
    // Thyroid
    if (($thyroidResults['thyronine_color_code'] == 'red') || ($thyroidResults['thyroxine_color_code'] == 'red') || ($thyroidResults['tsh_color_code'] == 'red')) {
    ...
    if (($kidneyResults['urea_result_color_code'] == 'red') || ($kidneyResults['creatinine_color_code'] == 'red') ||
        ...
        ($kidneyResults['creatinine_ratio_color_code'] == 'red') || ($kidneyResults['sodium_result_color_code'] == 'red') ||
        ...
        ($kidneyResults['creatinine_ratio_color_code'] == 'green') || ($kidneyResults['sodium_result_color_code'] == 'green') ||
    ...
    if (($liverResults['ggt_result_found_view'] == 1)) {
        if (($liverResults['bilirubin_color_code'] == 'red') || ($liverResults['bilirubin_direct_color_code'] == 'red') ||
            ...
            (($patientDetails['PackageCode'] !== 'AYN_016') && ($liverResults['ggt_color_code'] == 'red')) ||
            ...
            (($patientDetails['PackageCode'] !== 'AYN_016') && ($liverResults['ggt_color_code'] == 'orange')) ||
            ...
            (($patientDetails['PackageCode'] !== 'AYN_016') && ($liverResults['ggt_color_code'] == 'green')) ||
    ...
    if (($bloodResults['rbccount_color_code'] == 'red') || ($bloodResults['hematocrit_pcv_color_code'] == 'red') ||
        ...
        ($bloodResults['basophils_color_code'] == 'red') ||
        ($bloodResults['lactate_dehydragenase_LDH_serum__color_code'] == 'red') || ($bloodResults['erythrocyte_sedimentation_color_code'] == 'red') || ($bloodResults['mch_color_code'] == 'red')
    ) {
        ...
        ($bloodResults['basophils_color_code'] == 'orange') ||
        ($bloodResults['lactate_dehydragenase_LDH_serum__color_code'] == 'orange') || ($bloodResults['erythrocyte_sedimentation_color_code'] == 'orange') || ($bloodResults['mch_color_code'] == 'orange')
    ) {
        ...
        ($bloodResults['basophils_color_code'] == 'green') ||
    ...
    if (($miniralVitaminIronResults['vitaminbtwelve_color_code'] == 'red') || ($miniralVitaminIronResults['vitamind_color_code'] == 'red') ||
        ...
        //(! empty($miniralVitaminIronResults['ferritin_color_code']) == 'red') || 
        ...
        //(! empty($miniralVitaminIronResults['ferritin_color_code']) == 'orange') || 
        ($miniralVitaminIronResults['iron_color_code'] == 'orange') ||
        ($miniralVitaminIronResults['uibc_color_code'] == 'orange') || ($miniralVitaminIronResults['tibc_color_code'] == 'orange') ||  ($miniralVitaminIronResults['iron_saturation_color_code'] =='orange')
    ) {
        ...
        //(! empty($miniralVitaminIronResults['ferritin_color_code']) == 'green') || 
        ($miniralVitaminIronResults['iron_color_code'] == 'green') ||
        ($miniralVitaminIronResults['uibc_color_code'] == 'green') || ($miniralVitaminIronResults['tibc_color_code'] == 'green') ||  ($miniralVitaminIronResults['iron_saturation_color_code'] =='green')
    ) {
    ...
    // Cancer Makers
    if ($patientDetails['PackageCode'] == 'AYN_029') {
        if (
            $cancermakerResults['prostate_specific_antigen_total_serum_color_code'] == 'red'
        ) {
            $cancermakerResults['cancer-maker-summary'] = 'red-summary';
        } elseif (
            $cancermakerResults['prostate_specific_antigen_total_serum_color_code'] == 'orange'
        ) {
            $cancermakerResults['cancer-maker-summary'] = 'orange-summary';
        } elseif (
            $cancermakerResults['prostate_specific_antigen_total_serum_color_code'] == 'green'
        ) {
            $cancermakerResults['cancer-maker-summary'] = 'green-summary';
        } else {
            $cancermakerResults['cancer-maker-summary'] = '';
        }
    } else {
        if (
            $cancermakerResults['carcinoembryonic_antigen_serum_color_code'] == 'red'
        ) {
            $cancermakerResults['cancer-maker-summary'] = 'red-summary';
        } elseif (
            $cancermakerResults['carcinoembryonic_antigen_serum_color_code'] == 'orange'
        ) {
            $cancermakerResults['cancer-maker-summary'] = 'orange-summary';
        } elseif (
            $cancermakerResults['carcinoembryonic_antigen_serum_color_code'] == 'green'
        ) {
            $cancermakerResults['cancer-maker-summary'] = 'green-summary';
        } else {
            $cancermakerResults['cancer-maker-summary'] = '';
...
<div class='footer-cls' style='margin-top: 10px;'>
   ...
   <div class='clear-both' style='margin-top:10px;'>
        <p class='footer-adress' style='font-size:8px; padding:2px 5px 5px;'> No. 16, Vijayaraghava Lane, Vijayaraghava Road, T. Nagar,  Thygarayanagar , Chennai , Tamil Nadu - 600017</p>
    ...
    <div class="body-cl">
            ...
            <div class="resultDetails" style="page-break-after: always;">
                ...
                <div style="padding-top: 20px;">
                    <div style="text-align: center;font-weight: bold;font-size: 22px;">
                        <?php if ($patientDetails['PackageCode'] == 'AYN_029' && $patientDetails['patient_gender'] == 'Male') { ?>
                            <td style="color: #333;font-size: 16px; font-weight:600;">Ayushman - Comprehensive (M) package</td>
                        <?php } ?>
                        <?php if ($patientDetails['PackageCode'] == 'AYN_030' && $patientDetails['patient_gender'] == 'Female') { ?>
                            <td style="color: #333;font-size: 16px; font-weight:600;">Ayushman - Comprehensive (F) package</td>
                        <?php } ?>
                    </div>
                ...
                <footer style="position: absolute; bottom: -10px; left: 0; width: 100%; text-align: center; padding: 10px 0; page-break-before: always;">
                    ...
                    <?php
                    $currentPage = 1;
                    $totalPages = ($urineResults['urinestatus_found'] == 1) ? 26 : 28;
                    ?>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top: 20px;">
                <!-- <div style="text-align: end;">
                    <img src="https://cdn.shop.lifecell.in/reports/wellness/images/lc-logo.png" alt="" style="width: 20%;">
                </div> -->
                <div style="width:100%;">
                ...
                <div style="background-color: #e5f4f2;padding: 20px 50px;">
                    <p style="line-height: 24px; color: #a5247a;">
                        <span><b>The LifeCell Wellness Insights Report</b></span> gives you a quick overview of your overall health status. It summarises key findings from your lab results and lifestyle-related questions, highlighting areas that need attention.
                    </p>
                </div>
                <div>
                    <table style="padding-left:50px;">
                        <tr>
                            ...
                            <td class="health-font">
                                <span class="health-span">Health Journey Charts :</span> The Interactive Charts visually track your health parameters over time. They help you see how things have changed within your body which helps you keep accurate track of your health.
                            </td>
                        </tr>
                        <tr>
                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/mfine-bullets.png" alt="" class="health-jou"></td>
                            <td class="health-font">
                                <span class="health-span">Test Insights:</span> Using advanced technology and strict quality checks, this part dives deep into your test results. It explains each test you've done, sets ideal benchmarks, and points out areas that need immediate attention.
                            </td>
                        </tr>
                        <tr>
                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/mfine-bullets.png" alt="" class="health-jou"></td>
                            <td class="health-font">
                                <span class="health-span">Personalised Recommendations :</span> Get tailored advice to improve your nutrition and lifestyle choices. From managing your BMI to suggesting proactive tests and guiding you on future consultations, these suggestions.
                            </td>
                        </tr>
                        <tr>
                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/mfine-bullets.png" alt="" class="health-jou"> </td>
                            <td class="health-font">
                                <span class="health-span">Preventive Testing Guide :</span> This section is a quick guide to essential tests based on your age group. Find out which tests are recommended for you and how often you should schedule them to stay proactive about your health.
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <table style="width: 65%; margin-top:100px; margin-left:25px;" class="float-left border-collapse">
                    ...
                    <tr>
                        ...
                        <td class="healthy-summary">04</td>
                    </tr>
                    <tr>
            ...
            <div class="resultDetails" style="page-break-after: always; padding-top: 50px;">
                ...
                <div style="text-align: center; width:50%;" class="float-left">
                    ...
                    <?php if ($patientDetails['patient_gender'] == 'Female') { ?>
                        <img src="https://cdn.shop.lifecell.in/reports/wellness/images/female-health-pic.png" alt="" style="padding-bottom: 20px; width: 50%;">
                    <?php  } ?>
                </div>
                <table style="width: 45%; padding-top: 50px;" class="float-left">
                    ...
                    <tr>
                        ...
                        <?php if (($patientDetails['PackageCode'] == 'AYN_017') || ($patientDetails['PackageCode'] == 'AYN_016')) { ?>
                            <td class="pancreas-col">VITAMINS & IRON</td>
                        <?php } else { ?>
                            <td class="pancreas-col">VITAMINS,MINERALS & IRON</td>
                        <?php } ?>
                    </tr>
                    <tr>
                        <td class="<?= $cancermakerResults['cancer-maker-summary']; ?> d-block vitamins"> </td>
                        <td class="pancreas-col">CANCER MAKERS</td>
                    </tr>
                    ...
                    <tr>
                            ...
                            <div class="graphDetail">
                                ...
                                <div>
                                    <span class="<?= $pancreasResults['hba1c_color_code']; ?>" style="  font-size: 34px;">
                                        <?php echo (($pancreasResults['hbAlc_result_value'] != '') ? $pancreasResults['hbAlc_result_value'] : '') ?>
                                    </span> <?php echo htmlspecialchars($pancreasResults['hbAlc_uom']); ?>
                                </div>
                                <table class="image-result">
                                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <p> <span style="font-weight: bold;">Estimated Average Glucose: </span><?= $pancreasResults['estimated_average_glucose']; ?> <?= $pancreasResults['estimated_average_uom']; ?></p>
		...
		page-break-before: always;">
                    <div>
                        <?php //echo $footerWithLogo;
                        echo NewFooter(['H0005', 'S0013a'], $tgdrsig_details, $footerLogo, $patientDetails, $footerNablLogo);
                        ?>
                    </div>
                    <div class="pageno">Page <?= $currentPage++ ?> of <?= $totalPages ?></div>
                </footer>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <?php if (!empty($heartTestgroupdetails['H0013_heart_remarks']) || !empty($heartTestgroupdetails['lipid_profile_heart_remarks'])) { ?>
                    <div style="padding-top: 2.5px;">
                        <p class="sample-type-para">
                            <span class="p-tag" style="font-size: 16px;">Service Remarks :</span>
                        ...
                        <td class="leftPanel">
                            <div class="graphDetail">
                                ...
                                <table class="image-result">
                                    <tr>
                                        <?php
                                        if ($kidneyResults['creatinine_ratio_result_value'] < $kidneyResults['creatinine_ratio_low_result_value']) {
                                        ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                        <?php
                                        } elseif ($kidneyResults['creatinine_ratio_result_value'] >= $kidneyResults['creatinine_ratio_low_result_value'] && $kidneyResults['creatinine_ratio_result_value'] <=  $kidneyResults['creatinine_ratio_high_result_value']) {
                                        ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/green-thumbs.png" /></td>
                                        <?php
                                        } elseif ($kidneyResults['creatinine_ratio_result_value'] > $kidneyResults['creatinine_ratio_high_result_value']) {
                                        ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                        <?php
                                        }
            ...
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <div style="float:left;">
                    ...
                    if (
                        ...
                        !empty($kidneyResults['age_test_remraks']) ||
                            ...
                            <p class="sample-type-para">
                                ...
                                <span class="test-remarks suggestions-para sample-type-para">
                                    ...
                                    $remarks = array_filter([
                                        ...
                                        $kidneyResults['age_test_remraks'] ?? '',
                    ...
                    <td class="leftPanel">
                        <div class="graphDetail">
                            ...
                            <div>
                                ...
                                </span> <?php echo htmlspecialchars($liverResults['ag_ratio_uom']); ?>
                            </div>
                            <table class="image-result">
                                <tr>
                        ...
                        <td class="leftPanel">
                            <div class="graphDetail">
                                ...
                                <table class="mediacal-update">
                                    <tr>
                                        <td>Range</td>
                                        <td> : <?php echo $liverResults['amylase_high_result_value'] . " U/L"; ?> </td>
                                    </tr>
                                </table>
    ...
    <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
        <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
            ...
            <table cellspacing="0" cellpadding="0" class="graphBArContentSection float-left w-50" style="padding-left: 10px; padding-bottom:10%;">
                <tr>
                    <td class="leftPanel blood">
                        <div class="graphDetail">
                            <p style="color: #333;font-weight:600;">Your Result Value</p>
                    ...
                    <td class="leftPanel blood">
                        <div class="graphDetail">
                            ...
                            <div>
                                ...
                                </span> <?php echo htmlspecialchars($bloodResults['lymphocyte_uom']); ?>
                            </div>
                            <table class="image-result">
                                <tr>
    ...
    <div class="body-cl" style="margin-top:-75px;">
    ...
    <div class="body-cl"> -->
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <table cellspacing="0" cellpadding="0">
                    <tr class="d-block">
                        ...
                        <td style="padding-left:15px;"> <span style="width:100%;" class="result-title <?= $cancermakerResults['cancer-maker-summary']; ?>">Cancer Makers</span>
                    </tr>
                </table>
                <table>
                    <tr>
                ...
                <?php if ($patientDetails['PackageCode'] == 'AYN_029') { ?>
                    <?php
                    if ($patientAge < 40) {
                        $threshold = 2.0;
                    } elseif ($patientAge >= 40 && $patientAge <= 49) {
                        $threshold = 2.5;
                    } elseif ($patientAge >= 50 && $patientAge <= 59) {
                        $threshold = 3.5;
                    } elseif ($patientAge >= 60 && $patientAge <= 69) {
                        $threshold = 4.5;
                    } elseif ($patientAge >= 70 && $patientAge <= 79) {
                        $threshold = 6.5;
                    } else {
                        $threshold = 7.2;
                    }
                        ...
                        <tr>
                            <td class="leftPanel">
                                <div class="graphDetail">
                                    <p style="color: #333;font-weight:600;">Your Result Value</p>
                                    <div>
                                        <span class="<?= $cancermakerResults['prostate_specific_antigen_total_serum_color_code']; ?>" style="font-size: 34px;">
                                            <?php echo (($cancermakerResults['prostate_specific_antigen_total_serum_result_value'] != '') ? $cancermakerResults['prostate_specific_antigen_total_serum_result_value'] : '') ?>
                                        </span>
                                        <?php echo htmlspecialchars($cancermakerResults['prostate_specific_antigen_total_serum_uom']); ?>
                                    </div>
                                    <table class="image-result">
                                        <tr>
                                            <?php if ($cancermakerResults['prostate_specific_antigen_total_serum_result_value_cleaned'] < 0) { ?>
                                                <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                            <?php } ?>

                                            <?php if ($cancermakerResults['prostate_specific_antigen_total_serum_result_value_cleaned'] <= $threshold) { ?>
                                                <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/green-thumbs.png" /></td>
                                            <?php } ?>
                                            ...
                                            <?php if ($cancermakerResults['prostate_specific_antigen_total_serum_result_value_cleaned'] > $threshold) { ?>
                                                <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                            <?php } ?>
                                            <td class="<?= $cancermakerResults['prostate_specific_antigen_total_serum_color_code']; ?> image-ressult">
                                                <?php echo (($cancermakerResults['prostate_specific_antigen_total_serum_result_value_in_words'] != '') ? $cancermakerResults['prostate_specific_antigen_total_serum_result_value_in_words'] : '') ?>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="mediacal-update">
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    <div style="display: flex; align-items: center; justify-content: space-between; position: relative;">
                                        <h4 style="margin: 0;">Prostate Specific Antigen Total Serum </h4>
                                        <p class="methodology" style="margin: 0;"> <?= $cancermakerResults['prostate_specific_antigen_total_serum_sample_method']; ?> </p>
                                    </div>

                                    <!-- NABL Logo and Code Positioned Absolutely -->
                                    <div style="position: absolute; top: -5px; right: 0; display: flex; align-items: center;">

                                        <?php if ($cancermakerResults['prostate_specific_antigen_total_serum_is_nabl_accredited'] == 1  && !($patientDetails['hospital_logo']['combained'])): ?>
                                            <img src="https://reports.lifecell.in/images/footer-logo-pns-new.png" alt="" style="width: auto; height: 40px; margin-right: 10px;">
                                            <div style="color: #000; font-size: 8px; line-height: 8px;">
                                                <?= $cancerMakerTestgroupdetails['P0018b_cancer_nabl_code']; ?>
                                            </div>
                                        <?php endif; ?>

                                    </div>

                                    <?php if ($cancermakerResults['prostate_specific_antigen_total_serum_impact_on_health'] != '') { ?>
                                        <h4>Impact on health</h4>
                                        <p><?php echo ($cancermakerResults['prostate_specific_antigen_total_serum_impact_on_health'] != '') ? $cancermakerResults['prostate_specific_antigen_total_serum_impact_on_health'] : '' ?></p>
                                    <?php } ?>
                                </div>
                            </td>
                        </tr>
                ...
                <?php if ($patientDetails['PackageCode'] == 'AYN_030') { ?>
                    <table cellspacing="0" cellpadding="0" class="graphBArContentSection">
                        <tr>
                            <td class="leftPanel">
                                <div class="graphDetail">
                                    <p style="color: #333;font-weight:600;">Your Result Value</p>
                                    <div>
                                        <span class="<?= $cancermakerResults['carcinoembryonic_antigen_serum_color_code']; ?>" style="font-size: 34px;">
                                            <?php echo (($cancermakerResults['carcinoembryonic_antigen_serum_result_value'] != '') ? $cancermakerResults['carcinoembryonic_antigen_serum_result_value'] : '') ?>
                                        </span><?php echo htmlspecialchars($cancermakerResults['carcinoembryonic_antigen_serum_uom']); ?>
                                    </div>
                                    <table class="image-result">
                                        <tr>
                                            <?php if ($cancermakerResults['carcinoembryonic_antigen_serum_result_value'] < $cancermakerResults['carcinoembryonic_antigen_serum_low_result_value']) { ?>
                                                <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                            <?php } ?>
                                            <?php if ($cancermakerResults['carcinoembryonic_antigen_serum_result_value'] < $cancermakerResults['carcinoembryonic_antigen_serum_high_result_value']) { ?>
                                                <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/green-thumbs.png" /></td>
                                            <?php } ?>
                                            <?php if ($cancermakerResults['carcinoembryonic_antigen_serum_result_value'] >= $cancermakerResults['carcinoembryonic_antigen_serum_high_result_value']) { ?>
                                                <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                            <?php } ?>
                                            <td class="<?= $cancermakerResults['carcinoembryonic_antigen_serum_color_code']; ?> image-ressult">
                                                <?php echo (($cancermakerResults['carcinoembryonic_antigen_serum_result_value_in_words'] != '') ? $cancermakerResults['carcinoembryonic_antigen_serum_result_value_in_words'] : '') ?>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="mediacal-update">
                                        <?php if (!empty($cancermakerResults['carcinoembryonic__BRInterval_result_value'])) { ?>
                                            <?php
                                            foreach ($cancermakerResults['carcinoembryonic_reference_ranges_value'] as $label => $range) {
                                                echo "<tr>";
                                                echo "<td>" . ucwords($label) . "</td>";
                                                echo "<td>: $range</td>";
                                                echo "<td>" . $cancermakerResults['carcinoembryonic_antigen_serum_uom'] . "</td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                        <?php } else { ?>
                                            <td>Range</td>
                                            <td> : <?php echo $cancermakerResults['carcinoembryonic_antigen_serum_low_result_value'] . " - " . $cancermakerResults['carcinoembryonic_antigen_serum_high_result_value'] . " " . $cancermakerResults['carcinoembryonic_antigen_serum_uom']; ?> </td>
                                        <?php } ?>
                                    </table>
                            ...
                            <td class="rightPanel">
                                <div class="graphContent" style="position: relative;">
                                    <div style="display: flex; align-items: center; justify-content: space-between; position: relative;">
                                        <h4 style="margin: 0;">Carcino Embryonic Antigen Serum</h4>
                                        <p class="methodology" style="margin: 0;"> <?= $cancermakerResults['carcinoembryonic_antigen_serum_sample_method']; ?> </p>
                                    </div>
                                    <!-- NABL Logo and Code Positioned Absolutely -->
                                    <div style="position: absolute; top: -5px; right: 0; display: flex; align-items: center;">
                                        <?php if ($cancermakerResults['carcinoembryonic_antigen_serum_is_nabl_accredited'] == 1  && !($patientDetails['hospital_logo']['combained'])): ?>
                                            <img src="https://reports.lifecell.in/images/footer-logo-pns-new.png" alt="" style="width: auto; height: 40px; margin-right: 10px;">
                                            <div style="color: #000; font-size: 8px; line-height: 8px;">
                                                <?= $cancerMakerTestgroupdetails['C0012a_cancer_nabl_code']; ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <?php if ($cancermakerResults['carcinoembryonic_antigen_serum_impact_on_health'] != '') { ?>
                                        <h4>Impact on health</h4>
                                        <p><?php echo ($cancermakerResults['carcinoembryonic_antigen_serum_impact_on_health'] != '') ? $cancermakerResults['carcinoembryonic_antigen_serum_impact_on_health'] : '' ?></p>
                                    <?php } ?>
                                </div>
                            </td>
                        </tr>
                ...
                <?php
                if (
                    !empty($cancermakerResults['prostate_specific_antigen_total_serum_test_remraks'])
                    || !empty($cancermakerResults['glucose_fasting_test_remraks'])
                ) {
                ?>
                    <div style="padding-top: 10px;">
                        <p class="sample-type-para">
                            ...
                            <span class="test-remarks suggestions-para sample-type-para">
                                <?php
                                $remarks = array_filter([
                                    $cancermakerResults['prostate_specific_antigen_total_serum_test_remraks'] ?? '',
                                    $cancermakerResults['carcinoembryonic_antigen_serum_test_remraks'] ?? '',
            ...
            <footer style="position: absolute; bottom: -10px; left: 0; width: 100%; text-align: center; padding: 10px 0; page-break-before: always;">
                <div>
                    <?php //echo $footerWithLogo;
                    echo NewFooter(['P0018b', 'C0012a'], $tgdrsig_details, $footerLogo, $patientDetails, $footerNablLogo);
                    ?>
                </div>
                <div class="pageno">Page <?= $currentPage++ ?> of <?= $totalPages ?></div>
            </footer>
                ...
                <table>
                    <tr class="d-block">
                        <td style="border-right: 1px solid #00977b; padding-right: 10px;padding-left: 10px;">
                            <img style="width:50px;" src="https://cdn.shop.lifecell.in/reports/wellness/images/nutrition-icon.png" alt="">
                        </td>
                        <td></td>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <table>
                    <tr class="d-block">
                        <td style="border-right: 1px solid #00977b;padding-right: 10px;padding-left: 10px;">
                            <img style="width:50px;" src="https://cdn.shop.lifecell.in/reports/wellness/images/physical-activity-icon.png" alt="">
                        </td>
                        <td></td>
                ...
                <table>
                    <tr class="d-block">
                        <td style="border-right: 1px solid #00977b;padding-right: 10px;padding-left: 10px;">
                            <img style="width:50px;" src="https://cdn.shop.lifecell.in/reports/wellness/images/balanced-diet-icon.png" alt="">
                        </td>
                        <td></td>
                ...
                <table>
                    <tr class="d-block">
                        <td style="border-right: 1px solid #00977b;padding-right: 10px;padding-left: 10px;">
                            <img style="width:50px;" src="https://cdn.shop.lifecell.in/reports/wellness/images/stress-management-icon.png" alt="">
                        </td>
                        <td></td>
                ...
                <table class="border-collapse" style="width:100%; margin: 10px; border: 1px solid #777;">
                    ...
                    <tr>
                        <?php
                        // If LDL status found → include VLDL
                        if (!empty($heartResults['lipoprotein_ldl_status_found'])) {
                        ...
                        <?php } else { ?>
                            <td class="tests">Heart -
                                ...
                                <?= !empty($heartResults['lipoprotein_ldl_status_found']) ? $heartResults['very_low_Density_lipoprotein'] : '' ?>
                    ...
                    <tr>
                        ...
                        <?php if (
                            ...
                            $kidneyResults['uricacid_color_code'] == 'green' && $kidneyResults['calcium_color_code'] == 'green' &&
                            $kidneyResults['blood_urea_nitrogen_color_code'] == 'green' &&
                            $kidneyResults['creatinine_ratio_color_code'] == 'green' && $kidneyResults['magnesium_color_code'] == 'green' && $kidneyResults['sodium_result_color_code'] == 'green' && $kidneyResults['potassium_result_color_code'] == 'green' && $kidneyResults['chloride_result_color_code'] == 'green' && $kidneyResults['egfr_color_code'] == 'green'
                        ) { ?>
                            <td class="tests">Kidney - Nill
                            </td>
                        <?php   } else { ?>
                    ...
                    <tr>
                        ...
                        <?php if (
                            ...
                            $bloodResults['pdw_color_code'] == 'green' && $bloodResults['platelet_crit_color_code'] == 'green' && $bloodResults['lymphocyte_count_color_code'] == 'green' &&
                            $bloodResults['eosinophil_count_color_code'] == 'green' && $bloodResults['basophil_count_color_code'] == 'green' && $bloodResults['neutrophils_color_code'] == 'green' &&
                            $bloodResults['lymphocyte_color_code'] == 'green' && $bloodResults['monocytes_color_code'] == 'green' && $bloodResults['lactate_dehydragenase_LDH_serum__color_code'] == 'green' && ($bloodResults['erythrocyte_sedimentation_color_code'] == 'green') && $bloodResults['mch_color_code'] == 'green'
                        ) { ?>
                            <td class="tests">Blood - Nil </td>
                        <?php } else { ?>
                    ...
                    <tr>
                        ...
                        <?php if ($allGreen) { ?>
                            <?php if ($patientDetails['PackageCode'] == 'AYN_017' || $patientDetails['PackageCode'] == 'AYN_016') { ?>
                                <td class="tests">Vitamins & Iron - Nil</td>
                            <?php } else { ?>
                                <td class="tests">Vitamins, Minerals & Iron - Nil</td>
                            <?php } ?>
                        <?php } else { ?>
                            <?php if ($patientDetails['PackageCode'] == 'AYN_017' || $patientDetails['PackageCode'] == 'AYN_016') { ?>
                                <td class="tests">Vitamins & Iron -
                                <?php } else { ?>
                                <td class="tests">Vitamins, Minerals & Iron -
                                <?php } ?>
                                <?= $miniralVitaminIronResults['vitaminbtwelve_color'] ?>
                                <?= $miniralVitaminIronResults['vitamind_twentyfive'] ?>
                                <?= $miniralVitaminIronResults['phosphorus'] ?>
                    ...
                    <tr>
                        <?php
                        if ($patientDetails['PackageCode'] == 'AYN_029') {
                            if ($cancermakerResults['prostate_specific_antigen_total_serum_color_code'] != 'green') {
                                $cancermakerResults['prostate_specific_antigen_total_serum'] = 'Prostate Specific Antigen Total Serum,';
                            } else {
                                $cancermakerResults['prostate_specific_antigen_total_serum'] = '';
                            }
                        } else {
                            if ($cancermakerResults['carcinoembryonic_antigen_serum_color_code'] != 'green') {
                                $cancermakerResults['carcinoembryonic_antigen_serum'] = 'Carcino Embryonic Antigen Serum,';
                            } else {
                                $cancermakerResults['carcinoembryonic_antigen_serum'] = '';
                            }
                        }
                        if (
                            ($patientDetails['PackageCode'] == 'AYN_029' && $cancermakerResults['prostate_specific_antigen_total_serum_color_code'] == 'green') ||
                            ($patientDetails['PackageCode'] != 'AYN_029' && $cancermakerResults['carcinoembryonic_antigen_serum_color_code'] == 'green')
                        ) {
                            $cancerMarkerOutput = "Cancer Markers - Nil";
                        } else {
                            $cancerMarkerOutput = "Cancer Markers - ";
                            if ($patientDetails['PackageCode'] == 'AYN_029' && $cancermakerResults['prostate_specific_antigen_total_serum_color_code'] != 'green') {
                                $cancerMarkerOutput .= $cancermakerResults['prostate_specific_antigen_total_serum'];
                            }
                            if ($patientDetails['PackageCode'] != 'AYN_029' && $cancermakerResults['carcinoembryonic_antigen_serum_color_code'] != 'green') {
                                $cancerMarkerOutput .= $cancermakerResults['carcinoembryonic_antigen_serum'];
                            }
                        }
                        ?>
                        <td class="tests">
                        ...
                        <tr>
                            ...
                            <?php if (!$urineResults['urinestatus_found']) { ?>
                                <?php if (
                                    ...
                                    $urineResults['rbcs_color_code'] == 'green' && $urineResults['casts_color_code'] == 'green' && $urineResults['bacteria_color_code'] == 'green'
                                ) { ?>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="padding-top:50px;">
                ...
                <footer style="position: absolute; bottom: -303px; left: 0; width: 100%; text-align: center; padding: 10px 0; page-break-before: always;">
                    <div>
                        <?php echo $footerWithLogo; ?>
                    </div>
                    <div class="pageno">Page <?= $currentPage++ ?> of <?= $totalPages ?></div>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-before:always;">
               <div style="width:100%; position: absolute;">
                    <br>
                    <?php echo $co_brand_banner; ?>
                </div>
