...
<body onload="number_pages()">
    ...
    //print '<pre>';
    // print_r($pancreasTestgroupdetails);
    //exit;
    ...
    if (($kidneyResults['urea_result_color_code'] == 'red') || ($kidneyResults['creatinine_color_code'] == 'red') ||
        ...
        ($kidneyResults['potassium_result_color_code'] == 'red') || ($kidneyResults['chloride_result_color_code'] == 'red') || ($kidneyResults['magnesium_color_code'] == 'red') ||  ($kidneyResults['egfr_color_code'] == 'red')
    ) {
        ...
        ($kidneyResults['potassium_result_color_code'] == 'orange') || ($kidneyResults['chloride_result_color_code'] == 'orange') || ($kidneyResults['magnesium_color_code'] == 'orange')  || ($kidneyResults['egfr_color_code'] == 'orange')
    ) {
        ...
        ($kidneyResults['potassium_result_color_code'] == 'green') || ($kidneyResults['chloride_result_color_code'] == 'green') || ($kidneyResults['magnesium_color_code'] == 'green') ||  ($kidneyResults['egfr_color_code'] == 'green')
    ) {
            ...
            <div class="resultDetails" style="page-break-after: always;">
                ...
                <div style="padding-top: 20px;">
                    <div style="text-align: center;font-weight: bold;font-size: 22px;">
                        <td style="color: #333;font-size: 16px; font-weight:600; ">Tax Saver (F)</td>
                    </div>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent">
                                <div class="graphContent" style="position: relative;">
                                    ...
                                    <p> <span style="font-weight: bold;">Estimated Average Glucose: </span><?= $pancreasResults['estimated_average_glucose']; ?> <?php echo htmlspecialchars($pancreasResults['estimated_average_uom']); ?></p>
                    ...
                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent">
                                <div class="graphContent" style="position: relative;">
                                    <div style="display: flex; align-items: center; justify-content: space-between; position: relative;">
                                        <h4 style="margin: 0;">Lipase, Serum</h4>
                                        <p class="methodology" style="margin: 0;"> <?= $pancreasResults['lipase_sample_method']; ?> </p>
                                    </div>

                                    <!-- NABL Logo and Code Positioned Absolutely -->
                                    <div style="position: absolute; top: -5px; right: 0; display: flex; align-items: center;">

                                        <?php if ($pancreasResults['lipase_is_nabl_accredited'] == 1  && !($patientDetails['hospital_logo']['combained'])): ?>
                                            <img src="https://reports.lifecell.in/images/footer-logo-pns-new.png" alt="" style="width: auto; height: 40px; margin-right: 10px;">
                                            <div style="color: #000; font-size: 8px; line-height: 8px;">
                                                <?= $pancreasTestgroupdetails['L0005_pancreas_nabl_code']; ?>
                                            </div>
                                        <?php endif; ?>

                                    </div>

                                    <p style="margin-top:5px;">A lipase test measures the amount of lipase in the blood.</p>

                                    <?php if ($pancreasResults['lipase_impact_on_health'] != '') { ?>
                                        <h4>Impact on health</h4>
                                        <p><?php echo ($pancreasResults['lipase_impact_on_health'] != '') ? $pancreasResults['lipase_impact_on_health'] : '' ?></p>
                                    <?php } ?>
                                </div>
                        </td>
                    </tr>
                    ...
                    <td class="leftPanel">
                        <div class="graphDetail">
                            ...
                            <table class="image-result">
                                <tr>
                                    ...
                                    <td class="<?= $miniralVitaminIronResults['testosterone_color_code']; ?> image-ressult">
                                        <?php echo (($miniralVitaminIronResults['testosterone_result_value_in_words'] != '') ? $miniralVitaminIronResults['iron_result_value_in_words'] : '') ?>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="mediacal-update">
                                <tr>
                                    <td>Range </td>
                                    <td> : < <?php echo $miniralVitaminIronResults['testosterone_high_result_value'] . " ng/mL"; ?></td>
                                </tr>
                            </table>
                        </div>
                    </td>
                    ...
                    <tr>
                        ...
                        <?php if (!$urineResults['urinestatus_found']) { ?>
                            ...
                            <?php if (
                                ...
                                $urineResults['urine_protein_color_code'] == 'green' && $urineResults['urine_glucose_color_code'] == 'green' && $urineResults['bacteria_color_code'] == 'green' &&
