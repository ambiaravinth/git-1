            ...
            <div class="resultDetails" style="page-break-after: always;">
                ...
                <div style="padding-top: 20px;">
                    <div style="text-align: center;font-weight: bold;font-size: 22px;">
                        <?php if ($patientDetails['PackageCode'] == 'AYN_016' || $patientDetails['PackageCode'] == 'AYN_026' ||  $patientDetails['PackageCode'] == 'AYN_047') { ?>
            ...
            <div class="resultDetails" style="page-break-after: always; padding-top: 50px;">
                ...
                <table style="width: 45%; padding-top: 50px;" class="float-left">
                    ...
                    <tr>
                        ...
                        <?php if (($patientDetails['PackageCode'] == 'AYN_017') || ($patientDetails['PackageCode'] == 'AYN_026') || ($patientDetails['PackageCode'] == 'AYN_047')) { ?>
                    ...
                    <tr>
                        <td class="leftPanel">
                            <div class="graphDetail">
                                <p style="color: #333;font-weight:600;">Your Result Value</p>
                                <div>
                                    <span class="<?php //echo $kidneyResults['ra_factror_color_code']; ?>" style="font-size: 34px;">
                                ...
                                <table class="image-result">
                                    <tr>
                                        ...
                                        <?php //} else { ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                        <?php //} ?>
                                        <td class="<?php //echo $kidneyResults['ra_factror_color_code']; ?> image-ressult">
            ...
            <div class="resultDetails" style="page-break-after: always; padding-top:50px;">
                ...
                <table cellspacing="0" cellpadding="0">
                    <tr class="d-block">
                        ...
                        <?php if (($patientDetails['PackageCode'] == 'AYN_017') || ($patientDetails['PackageCode'] == 'AYN_026') || ($patientDetails['PackageCode'] == 'AYN_027') || ($patientDetails['PackageCode'] == 'AYN_047')) { ?>
