...
<body onload="number_pages()">
    ...
    // echo '<pre>';
    // echo base_url('css/wellness.css');
    // echo '</pre>';
    // exit;
    ...
    if (($bloodResults['rbccount_color_code'] == 'red') || ($bloodResults['hematocrit_pcv_color_code'] == 'red') ||
        ...
        ($bloodResults['basophils_color_code'] == 'red') || ($bloodResults['nrbc_color_code'] == 'red')  ||
        ($bloodResults['nrbc_percentage_color_code'] == 'red') || ($bloodResults['immature_granulocytes_count_color_code'] == 'red') ||
        ($bloodResults['immature_granulocytes_count_color_code'] == 'red') || ($bloodResults['mch_color_code'] == 'red')
    ) {
        ...
        ($bloodResults['basophils_color_code'] == 'orange') || ($bloodResults['nrbc_color_code'] == 'orange')  ||
        ($bloodResults['nrbc_percentage_color_code'] == 'orange') || ($bloodResults['immature_granulocytes_count_color_code'] == 'orange') ||
        ($bloodResults['immature_granulocytes_count_color_code'] == 'orange') || ($bloodResults['mch_color_code'] == 'orange')
    ) {
        ...
        ($bloodResults['basophils_color_code'] == 'green') || ($bloodResults['nrbc_color_code'] == 'green')  ||
        ($bloodResults['nrbc_percentage_color_code'] == 'green') || ($bloodResults['immature_granulocytes_count_color_code'] == 'green') ||
        ($bloodResults['immature_granulocytes_count_color_code'] == 'green') || ($bloodResults['mch_color_code'] == 'green')
    ) {
        $bloodResults['blood-summary'] = 'green-summary';
    }

    // Vitaminis
      if (($miniralVitaminIronResults['iron_color_code'] == 'red') || ($miniralVitaminIronResults['uibc_color_code'] == 'red') || ($miniralVitaminIronResults['tibc_color_code'] == 'red') ||  ($miniralVitaminIronResults['iron_saturation_color_code'] =='red')
    ) {
        $miniralVitaminIronResults['vit-min-iron-summary'] = 'red-summary';
    } elseif (($miniralVitaminIronResults['iron_color_code'] == 'orange') || ($miniralVitaminIronResults['uibc_color_code'] == 'orange') || ($miniralVitaminIronResults['tibc_color_code'] == 'orange') ||  ($miniralVitaminIronResults['iron_saturation_color_code'] =='orange')
    ) {
        $miniralVitaminIronResults['vit-min-iron-summary'] = 'orange-summary';
    } elseif (($miniralVitaminIronResults['iron_color_code'] == 'green') || ($miniralVitaminIronResults['uibc_color_code'] == 'green') || ($miniralVitaminIronResults['tibc_color_code'] == 'green') ||  ($miniralVitaminIronResults['iron_saturation_color_code'] =='green')
    ) {
    ...
    // if ($isNablAccredited) {
    //     $isNablImage = '<img src="https://cdn.shop.lifecell.in/reports/wellness/images/mc-logo-new.png" class="demo-dcn-img">';
    // } else {
    //     $isNablImage = '';
    // }
...
<div class='footer-cls' style='margin-top: 10px;'>
    ...
    <div class="body-cl">
            ...
            <div class="resultDetails" style="page-break-after: always;">
                ...
                <div style="padding-top: 20px;">
                    <div style="text-align: center;font-weight: bold;font-size: 22px;">
                        <?php if ($patientDetails['PackageCode'] == 'AYN_025') { ?>
                            <td style="color: #333;font-size: 16px; font-weight:600; ">Wellness - Total package</td>
                        <?php } ?>
		...
		page-break-before: always;">
                    ...
                    <?php
                    $currentPage = 1;
                    $totalPages = ($urineResults['urinestatus_found'] == 1) ? 22 : 24;
                    ?>
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <!-- <?php echo $header ?> -->
                <!-- header end -->
                <!-- <div style="width: 33%;" class="header-report-img">
                    <table class="border-collapse">
                        <tr>
                            <td>
                            <td>
                            <td><img style="width:78%; margin-right:-1.5rem; margin-top: -2.3rem; display:inline-block;" src='<?= base_url($wellnessQrCode); ?>' alt="" style="float:left; padding-right:20px;"></td>
                            </td>
                            </td>
                            <td><img style="width:65%; margin-top:-1rem;" src="https://cdn.shop.lifecell.in/reports/wellness/images/lc-logo.png" alt="" /></td>
                        </tr>
                    </table>
                </div> -->
                <div style="width:100%;">
                ...
                <table style="width: 65%; margin-top:100px; margin-left:25px;" class="float-left border-collapse">
                    ...
                    <tr>
                        ...
                        <td class="imp-para"><?= (!$urineResults['urinestatus_found']) ? '21' : '19' ?></td>
                    </tr>
                    <tr>
                        <td class="imp-para"><img src="https://cdn.shop.lifecell.in/reports/wellness/images/h-report-icon.png" alt="" /></td>
                        <td class="imp-para">Suggestions for Preventive Tests</td>
                        <td class="imp-para"><?= (!$urineResults['urinestatus_found']) ? '23' : '21' ?></td>
                    </tr>
                </table>
                ...
                <table style="width: 45%; padding-top: 50px;" class="float-left">
                    ...
                    <tr>
                        ...
                        <?php if (($patientDetails['PackageCode'] == 'AYN_017') || ($patientDetails['PackageCode'] == 'AYN_026')) { ?>
                            <td class="pancreas-col">VITAMINS</td>
                        <?php } else { ?>
                            <td class="pancreas-col">IRON</td>
                        <?php } ?>
                    </tr>
            ...
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <!-- <div style="width: 33%;" class="header-report-img">
                    <table class="border-collapse">
                        <tr>
                            <td><img style="width:78%; margin-right:-1.5rem; margin-top:-2.3rem; display:inline-block;" src='<?= base_url($wellnessQrCode); ?>' alt="" style="float:left; padding-right:20px;"></td>
                            <td><img style="width:75%; margin-top:-1.5rem;" src="https://cdn.shop.lifecell.in/reports/wellness/images/lc-logo.png" alt="" /></td>
                        </tr>
                    </table>
                </div> -->
                <div style="width:100%;">
        ...
        <div class="body-cl" style="min-height: 1110px; position: relative; padding: 0px;">
            <div class="resultDetails" style="page-break-after: always;padding-top:50px;">
                ...
                <?php } ?>
                <?php if ($patientDetails['PackageCode'] !== 'AYN_017' && $patientDetails['PackageCode'] !== 'AYN_018' && $patientDetails['PackageCode'] !== 'AYN_026' && $patientDetails['PackageCode'] !== 'AYN_025') { ?>
                    <table cellspacing="0" cellpadding="0" class="graphBArContentSection">
                        <tr>
                            <td class="leftPanel">
                                <div class="graphDetail">
                                    ...
                                    <!-- <table class="image-result">
                            <tr>
                                <?php if ($miniralVitaminIronResults['ra_factror_result_value'] < 250) { ?>
                                    <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                <?php } ?>

                                <?php if ($miniralVitaminIronResults['ra_factror_result_value'] > 400) { ?>
                                    <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                <?php } ?>
                                <td class="<?= $miniralVitaminIronResults['ra_factror_color_code']; ?> image-ressult">
                                    <?php echo (($miniralVitaminIronResults['ra_factror_result_value_in_words'] != '') ? $miniralVitaminIronResults['ra_factror_result_value_in_words'] : '') ?>
                                </td>
                            </tr>
                        </table> -->
                                </div>
                    ...
                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <p style="margin-top:5px;">Albumin to Globulin ratio used for comparison of concentration of Albumin & Globulin in your blood</p>
                    ...
                    <tr>
                            ...
                            <div class="graphDetail">
                                ...
                                <table class="image-result">
                                    <tr>
                                        ...
                                        <?php if ($bloodResults['corpuscular_volume_result_value'] > 101) { ?>
                                            <td><img src="https://cdn.shop.lifecell.in/reports/wellness/images/red-thumb.png" /></td>
                                        <?php } ?>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <p>Mean Corpuscular Volume test is used to evaluate the average size and volume of RBCs in your blood. This test helps to understand anaemia conditions</p>
                                <!-- NABL Logo and Code Positioned Absolutely -->
                    ...
                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <p>Red Cell Distribution Width SD is used to rule out conditions like infections, and malnutrition in your body</p>
                                <!-- NABL Logo and Code Positioned Absolutely -->
                    ...
                    <tr>
                        ...
                        <td class="rightPanel">
                            <div class="graphContent" style="position: relative;">
                                ...
                                <p>Absolute Lymphocyte Count test checks levels of Lymphocytes in the blood. This test is used to check the presence of infection</p>
                                <!-- NABL Logo and Code Positioned Absolutely -->
            ...
            <div class="resultDetails" style="page-break-after: always; padding-top:50px;">
                ...
                <table cellspacing="0" cellpadding="0">
                    <tr class="d-block">
                        ...
                        <?php if (($patientDetails['PackageCode'] == 'AYN_017') || ($patientDetails['PackageCode'] == 'AYN_026')) { ?>
                            <td style="padding-left:15px;"> <span style="width:100%;" class="result-title <?= $miniralVitaminIronResults['vit-min-iron-summary']; ?>">Vitamins</span>
                            <?php } else { ?>
                            <td style="padding-left:15px;"> <span style="width:100%;" class="result-title <?= $miniralVitaminIronResults['vit-min-iron-summary']; ?>">Iron</span>
                            <?php } ?>
                            </td>
                    </tr>
                </table>
                ...
                <div style="float:left;">
                    ...
                    <?php if (!empty($min_vit_iron_Testgroupdetails['iron_studies_min_vit_iron_remarks'])) { ?>
                        <div style="padding-top: 2.5px;">
                            <p class="sample-type-para">
                                <span class="p-tag" style="font-size: 16px;">Service Remarks :</span>
